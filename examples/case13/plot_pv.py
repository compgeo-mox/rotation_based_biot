...
def main(in_file_name, out_file_name):
    ...
    sol_2_00000vtu.CellArrayStatus = ['p', 'p_ex', 'q', 'r', 'u', 'u_ex']
    ...
    plotOverLine1Display_1.SeriesVisibility = ['p', 'p_ex', 'q_Magnitude', 'r', 'u_Magnitude', 'u_ex_Magnitude']
    plotOverLine1Display_1.SeriesLabel = ['arc_length', 'arc_length', 'p', 'p', 'p_ex', 'p_ex', 'q_X', 'q_X', 'q_Y', 'q_Y', 'q_Z', 'q_Z', 'q_Magnitude', 'q_Magnitude', 'r', 'r', 'u_X', 'u_X', 'u_Y', 'u_Y', 'u_Z', 'u_Z', 'u_Magnitude', 'u_Magnitude', 'u_ex_X', 'u_ex_X', 'u_ex_Y', 'u_ex_Y', 'u_ex_Z', 'u_ex_Z', 'u_ex_Magnitude', 'u_ex_Magnitude', 'vtkValidPointMask', 'vtkValidPointMask', 'Points_X', 'Points_X', 'Points_Y', 'Points_Y', 'Points_Z', 'Points_Z', 'Points_Magnitude', 'Points_Magnitude']
    plotOverLine1Display_1.SeriesColor = ['arc_length', '0', '0', '0', 'p', '0.89', '0.1', '0.11', 'p_ex', '0.22', '0.49', '0.72', 'q_X', '0.3', '0.69', '0.29', 'q_Y', '0.6', '0.31', '0.64', 'q_Z', '1', '0.5', '0', 'q_Magnitude', '0.65', '0.34', '0.16', 'r', '0', '0', '0', 'u_X', '0.89', '0.1', '0.11', 'u_Y', '0.22', '0.49', '0.72', 'u_Z', '0.3', '0.69', '0.29', 'u_Magnitude', '0.6', '0.31', '0.64', 'u_ex_X', '1', '0.5', '0', 'u_ex_Y', '0.65', '0.34', '0.16', 'u_ex_Z', '0', '0', '0', 'u_ex_Magnitude', '0.89', '0.1', '0.11', 'vtkValidPointMask', '0.22', '0.49', '0.72', 'Points_X', '0.3', '0.69', '0.29', 'Points_Y', '0.6', '0.31', '0.64', 'Points_Z', '1', '0.5', '0', 'Points_Magnitude', '0.65', '0.34', '0.16']
    plotOverLine1Display_1.SeriesPlotCorner = ['arc_length', '0', 'p', '0', 'p_ex', '0', 'q_X', '0', 'q_Y', '0', 'q_Z', '0', 'q_Magnitude', '0', 'r', '0', 'u_X', '0', 'u_Y', '0', 'u_Z', '0', 'u_Magnitude', '0', 'u_ex_X', '0', 'u_ex_Y', '0', 'u_ex_Z', '0', 'u_ex_Magnitude', '0', 'vtkValidPointMask', '0', 'Points_X', '0', 'Points_Y', '0', 'Points_Z', '0', 'Points_Magnitude', '0']
    plotOverLine1Display_1.SeriesLabelPrefix = ''
    plotOverLine1Display_1.SeriesLineStyle = ['arc_length', '1', 'p', '1', 'p_ex', '1', 'q_X', '1', 'q_Y', '1', 'q_Z', '1', 'q_Magnitude', '1', 'r', '1', 'u_X', '1', 'u_Y', '1', 'u_Z', '1', 'u_Magnitude', '1', 'u_ex_X', '1', 'u_ex_Y', '1', 'u_ex_Z', '1', 'u_ex_Magnitude', '1', 'vtkValidPointMask', '1', 'Points_X', '1', 'Points_Y', '1', 'Points_Z', '1', 'Points_Magnitude', '1']
    plotOverLine1Display_1.SeriesLineThickness = ['arc_length', '2', 'p', '2', 'p_ex', '2', 'q_X', '2', 'q_Y', '2', 'q_Z', '2', 'q_Magnitude', '2', 'r', '2', 'u_X', '2', 'u_Y', '2', 'u_Z', '2', 'u_Magnitude', '2', 'u_ex_X', '2', 'u_ex_Y', '2', 'u_ex_Z', '2', 'u_ex_Magnitude', '2', 'vtkValidPointMask', '2', 'Points_X', '2', 'Points_Y', '2', 'Points_Z', '2', 'Points_Magnitude', '2']
    plotOverLine1Display_1.SeriesMarkerStyle = ['arc_length', '0', 'p', '0', 'p_ex', '0', 'q_X', '0', 'q_Y', '0', 'q_Z', '0', 'q_Magnitude', '0', 'r', '0', 'u_X', '0', 'u_Y', '0', 'u_Z', '0', 'u_Magnitude', '0', 'u_ex_X', '0', 'u_ex_Y', '0', 'u_ex_Z', '0', 'u_ex_Magnitude', '0', 'vtkValidPointMask', '0', 'Points_X', '0', 'Points_Y', '0', 'Points_Z', '0', 'Points_Magnitude', '0']
    plotOverLine1Display_1.SeriesMarkerSize = ['arc_length', '4', 'p', '4', 'p_ex', '4', 'q_X', '4', 'q_Y', '4', 'q_Z', '4', 'q_Magnitude', '4', 'r', '4', 'u_X', '4', 'u_Y', '4', 'u_Z', '4', 'u_Magnitude', '4', 'u_ex_X', '4', 'u_ex_Y', '4', 'u_ex_Z', '4', 'u_ex_Magnitude', '4', 'vtkValidPointMask', '4', 'Points_X', '4', 'Points_Y', '4', 'Points_Z', '4', 'Points_Magnitude', '4']
    ...
    plotOverLine1Display_1.SeriesVisibility = ['p', 'p_ex', 'q_Magnitude', 'u_Magnitude', 'u_ex_Magnitude']
    plotOverLine1Display_1.SeriesColor = ['arc_length', '0', '0', '0', 'p', '0.889998', '0.100008', '0.110002', 'p_ex', '0.220005', '0.489998', '0.719997', 'q_X', '0.300008', '0.689998', '0.289998', 'q_Y', '0.6', '0.310002', '0.639994', 'q_Z', '1', '0.500008', '0', 'q_Magnitude', '0.650004', '0.340002', '0.160006', 'r', '0', '0', '0', 'u_X', '0.889998', '0.100008', '0.110002', 'u_Y', '0.220005', '0.489998', '0.719997', 'u_Z', '0.300008', '0.689998', '0.289998', 'u_Magnitude', '0.6', '0.310002', '0.639994', 'u_ex_X', '1', '0.500008', '0', 'u_ex_Y', '0.650004', '0.340002', '0.160006', 'u_ex_Z', '0', '0', '0', 'u_ex_Magnitude', '0.889998', '0.100008', '0.110002', 'vtkValidPointMask', '0.220005', '0.489998', '0.719997', 'Points_X', '0.300008', '0.689998', '0.289998', 'Points_Y', '0.6', '0.310002', '0.639994', 'Points_Z', '1', '0.500008', '0', 'Points_Magnitude', '0.650004', '0.340002', '0.160006']
    plotOverLine1Display_1.SeriesPlotCorner = ['Points_Magnitude', '0', 'Points_X', '0', 'Points_Y', '0', 'Points_Z', '0', 'arc_length', '0', 'p', '0', 'p_ex', '0', 'q_Magnitude', '0', 'q_X', '0', 'q_Y', '0', 'q_Z', '0', 'r', '0', 'u_Magnitude', '0', 'u_X', '0', 'u_Y', '0', 'u_Z', '0', 'u_ex_Magnitude', '0', 'u_ex_X', '0', 'u_ex_Y', '0', 'u_ex_Z', '0', 'vtkValidPointMask', '0']
    plotOverLine1Display_1.SeriesLineStyle = ['Points_Magnitude', '1', 'Points_X', '1', 'Points_Y', '1', 'Points_Z', '1', 'arc_length', '1', 'p', '1', 'p_ex', '1', 'q_Magnitude', '1', 'q_X', '1', 'q_Y', '1', 'q_Z', '1', 'r', '1', 'u_Magnitude', '1', 'u_X', '1', 'u_Y', '1', 'u_Z', '1', 'u_ex_Magnitude', '1', 'u_ex_X', '1', 'u_ex_Y', '1', 'u_ex_Z', '1', 'vtkValidPointMask', '1']
    plotOverLine1Display_1.SeriesLineThickness = ['Points_Magnitude', '2', 'Points_X', '2', 'Points_Y', '2', 'Points_Z', '2', 'arc_length', '2', 'p', '2', 'p_ex', '2', 'q_Magnitude', '2', 'q_X', '2', 'q_Y', '2', 'q_Z', '2', 'r', '2', 'u_Magnitude', '2', 'u_X', '2', 'u_Y', '2', 'u_Z', '2', 'u_ex_Magnitude', '2', 'u_ex_X', '2', 'u_ex_Y', '2', 'u_ex_Z', '2', 'vtkValidPointMask', '2']
    plotOverLine1Display_1.SeriesMarkerStyle = ['Points_Magnitude', '0', 'Points_X', '0', 'Points_Y', '0', 'Points_Z', '0', 'arc_length', '0', 'p', '0', 'p_ex', '0', 'q_Magnitude', '0', 'q_X', '0', 'q_Y', '0', 'q_Z', '0', 'r', '0', 'u_Magnitude', '0', 'u_X', '0', 'u_Y', '0', 'u_Z', '0', 'u_ex_Magnitude', '0', 'u_ex_X', '0', 'u_ex_Y', '0', 'u_ex_Z', '0', 'vtkValidPointMask', '0']
    plotOverLine1Display_1.SeriesMarkerSize = ['Points_Magnitude', '4', 'Points_X', '4', 'Points_Y', '4', 'Points_Z', '4', 'arc_length', '4', 'p', '4', 'p_ex', '4', 'q_Magnitude', '4', 'q_X', '4', 'q_Y', '4', 'q_Z', '4', 'r', '4', 'u_Magnitude', '4', 'u_X', '4', 'u_Y', '4', 'u_Z', '4', 'u_ex_Magnitude', '4', 'u_ex_X', '4', 'u_ex_Y', '4', 'u_ex_Z', '4', 'vtkValidPointMask', '4']
...
if __name__ == "__main__":
    ...
    main_folder = "/home/elle/Dropbox/Work/PresentazioniArticoli/2022/projects/rotation_based_biot/rotation_based_biot/examples/case13/"
